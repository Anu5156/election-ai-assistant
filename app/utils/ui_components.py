...
def render_metrics_row(t_func, countdown_display: str, election_date: datetime):
    ...
    <div class="metric-grid">
      {metric_card(t_func("Registration"), "✓", t_func("Voter ID verified"), t_func("Active"), "badge-green", "#22c55e")}
      {metric_card(t_func("Stations Nearby"), "3", t_func("Within 2 km radius"), t_func("Mapped"), "badge-blue", "#3b82f6")}
      {metric_card(t_func("Crowd Level"), t_func("Low"), t_func("Best time: 9–11 AM"), t_func("Updated"), "badge-amber", "#f59e0b")}
      {metric_card(t_func("Election Countdown"), countdown_display, t_func(election_date.strftime('%B %d, %Y')), t_func("Lok Sabha"), "badge-red", "#ef4444")}
    </div>
    """
